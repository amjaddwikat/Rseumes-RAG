...
try:
    ...
    # fallback: define a no-op load_dotenv if python-dotenv isn't installed
    def load_dotenv(*args, **kwargs):
        return None
try:
    # prefer sentence-transformers package for the SentenceTransformer class
...
try:
    ...
    # lightweight placeholders for static analysis / environments without langchain_core
    ...
    class RunnableLambda:
        ...
        def __ror__(self, other):
            # emulate simple piping: call fn on the value when used
            class _Run:
                ...
                def __call__(self, *args, **kwargs):
                    return self.fn(self.val)

            return _Run(self.fn, other)
